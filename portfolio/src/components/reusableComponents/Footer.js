        ...
        <footer>
            <div className="footer__cont">
                ...
                <ul className="footer__cont-social">
                    <a href="https://github.com/JacobWestby"><img src={githubIcon} alt="Github icon link" /></a>
                    <a href="https://www.linkedin.com/in/jacob-westby-dev93/"><img src={linkedinIcon} alt="Linkedin icon link" /></a>
                </ul>
